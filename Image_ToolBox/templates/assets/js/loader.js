...
var switchFunctionality = {
    ...
    setMode: function() {
        ...
        if (Cookies.getCookie('dark_mode') != "") {
            ...
            if(imgLogo) {
                imgLogo.setAttribute('src', '/static/img/painting.png');
            }
            ...
            for (var i = 0; i < linkElement.length; i++) {
                ...
                if( getHref == "/static/css/loader.css" ) {
                } else {
                    ...
                    if(n) {
                        ...
                        source = getHref.split('/static/')
                        linkElement[i].setAttribute('href', '/static/dark/assets/' + source[1]);
                    }
                }
            }
            ...
            for (var i = 0; i < scriptElement.length; i++) {
                ...
                if( getSrc == "/static/js/loader.js" ) {
                } else {
                    source = getSrc.split('/static/')
                    scriptElement[i].setAttribute('src', '/static/dark/assets/' + source[1]);
                }
            }
